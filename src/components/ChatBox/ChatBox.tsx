...
import {getWeekday, queryAndSetBills} from '../../utils/index.ts';
import {
  getFormatDate,
  getFormatTime,
  getWeekdayForShow,
...
import {analyseText} from '../../utils/analyse.ts';
        ...
        <View style={[styles.messageContainer, styles.systemMessage]}>
          ...
          <View style={[styles.textContainer]}>
            <Text style={styles.messageText} numberOfLines={1}>
              {getFormatDate(recordDate) +
                '  ' +
                getWeekdayForShow(recordDate) +
                '  ' +
                getFormatTime(recordDate)}
            </Text>
            <Text style={styles.messageText} numberOfLines={1}>
              {`内容: ${content}`}
            </Text>
